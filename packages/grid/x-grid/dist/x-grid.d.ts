...
import { Localization as Localization$1 } from '@material-ui/core/locale';
...
declare type MuiComponentsLocalization = Localization$1['props'] | Localization$1['components'];
/**
 * Set the types of the texts in the grid.
 */
interface GridLocaleText extends Partial<MuiComponentsLocalization> {
    noRowsLabel: string;
 ...
 * The full grid API.
 */
interface GridApi extends GridCoreApi, GridComponentsApi, GridStateApi, GridDensityApi, GridEventsApi, GridRowApi, GridEditRowApi, GridParamsApi, GridColumnApi, GridSelectionApi, GridSortApi, GridVirtualizationApi, GridPaginationApi, GridCsvExportApi, GridFocusApi, GridFilterApi, GridColumnMenuApi, GridPreferencesPanelApi, GridLocaleTextApi, GridClipboardApi {
}
